...
Sprite_Picture.prototype.update = function() {
	...
	if( this.picture() ){
		...
		this.update_PFOE_effect();			//执行变换
		this.update_PFOE_bitmap();			//获取图片宽高
	}
};
//==============================
// * 帧刷新 - 执行变换
//==============================
Sprite_Picture.prototype.update_PFOE_effect = function() {
...
// * 帧刷新 - 获取图片宽高
//==============================
Sprite_Picture.prototype.update_PFOE_bitmap = function() {
...
Game_Picture.prototype.initialize = function() {
	...
	this._Drill_PFOE.opacity = 0;			// 透明度（不叠加）
...
Game_Picture.prototype.update = function() {
	...
	this.drill_PFOE_updateHidingSpring();
	this.drill_PFOE_updateHidingJump();
	this.drill_PFOE_updateHidingShrink();
	this.drill_PFOE_updateHidingHorizonFlat();
