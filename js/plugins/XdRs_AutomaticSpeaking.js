...
//=================================================================================================
function Sprite_SpeakingBg() {
    this.initialize.apply(this, arguments);
}
Sprite_SpeakingBg.prototype = Object.create(Sprite.prototype);
Sprite_SpeakingBg.prototype.constructor = Sprite_SpeakingBg;
Sprite_SpeakingBg.prototype.initialize = function(skin, width, height) {
    Sprite.prototype.initialize.call(this);
    this.bitmap = new Bitmap(width, height + 36);
    this.drawBg(skin);
};
Sprite_SpeakingBg.prototype.drawBg = function(skin) {
   var bitmap = ImageManager.loadSystem(skin);
   var w = this.width, h = this.height - 36;
   bitmap.addLoadListener(function(){
       this.bitmap.blt(bitmap, 0, 0, 18, 18, 0, 0);
       this.bitmap.blt(bitmap, 54, 0, 18, 18, w-18, 0);
       this.bitmap.blt(bitmap, 0, 54, 18, 18, 0, h-18);
       this.bitmap.blt(bitmap, 54, 54, 18, 18, w-18, h-18);
       this.bitmap.blt(bitmap, 18, 0, 36, 18, 18, 0, w-36);
       this.bitmap.blt(bitmap, 18, 54, 36, 18, 18, h-18, w-36);
       this.bitmap.blt(bitmap, 0, 18, 18, 36, 0, 18, 18, h-36);
       this.bitmap.blt(bitmap, 54, 18, 18, 36, w-18, 18, 18, h-36);
       this.bitmap.blt(bitmap, 18, 18, 36, 36, 18, 18, w-36, h-36);
       var ax = w / 2 - 12;
       this.bitmap.blt(bitmap, 0, 72, 24, 36, ax, h-5);
   }.bind(this));
};
//=================================================================================================
function Window_SpeakingTest() {
    this.initialize.apply(this, arguments);
}
Window_SpeakingTest.prototype = Object.create(Window_Base.prototype);
Window_SpeakingTest.prototype.constructor = Window_SpeakingTest;
Window_SpeakingTest.prototype.initialize = function(text) {
    Window_Base.prototype.initialize.call(this, 0, 0, 32, 32);
    this.drawTextEx(text, 0, 0);
};
Window_SpeakingTest.prototype.lineHeight = function() {
    return 20;
};
Window_SpeakingTest.prototype.standardFontSize = function() {
    return 14;
};
Window_SpeakingTest.prototype.standardPadding = function() {
    return 10;
};
//=================================================================================================
...
Window_AutomaticSpeaking.prototype.lineHeight = function() {
    return 20;
};
Window_AutomaticSpeaking.prototype.standardFontSize = function() {
    return 14;
};
Window_AutomaticSpeaking.prototype.standardPadding = function() {
    return 10;
};
...
Window_AutomaticSpeaking.prototype.resetWindow = function(text) {
    ...
    this.height = data.height + this.lineHeight()-12 + this._padding * 2;
    this.createContents();
    this.setupBg(this._windowskinName);
};
Window_AutomaticSpeaking.prototype.getTextSizeExData = function(text) {
    if (XdRsData.as.isMz()) return this.textSizeEx(text);
    else {
        var test = new Window_SpeakingTest(text);
        return test.getTextExData(0,0);
    };
};
Window_AutomaticSpeaking.prototype.setupBg = function() {
    if (this._windowskinName) {
        this.opacity = 0;
        this._bg = new Sprite_SpeakingBg(this._windowskinName, this.width, this.height);
        this.addChildToBack(this._bg);
    }
};
...
Window_AutomaticSpeaking.prototype.updatePosition = function() {
    ...
    this.y = sprite.y - sprite.patternHeight() - this.height - 36;
