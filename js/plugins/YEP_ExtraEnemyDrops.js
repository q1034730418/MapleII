...
Game_BattlerBase.prototype.addNewState = function(stateId) {
    ...
    if (this.isEnemy() && this instanceof Game_Enemy) this.markStruckState(stateId);
    if (stateId === this.deathStateId() && this.isEnemy() && this instanceof Game_Enemy) {
        this.markDeathTurn();
    }
};
...
Game_Action.prototype.applyItemUserEffect = function(target) {
    ...
    if (target && target.isEnemy() && target instanceof Game_Enemy) {
