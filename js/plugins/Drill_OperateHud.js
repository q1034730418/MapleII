...
　　var DrillUp = DrillUp || {}; 
	...
	/*-----------------自定义------------------*/
	DrillUp.g_OH_self_list_length = 23;
	...
	for (var i = 0; i < DrillUp.g_OH_self_list_length; i++) {
		if( DrillUp.parameters["自定义按钮-" + String(i+1) ] != undefined &&
			...
			DrillUp.g_OH_self_list[i]['btn_src'] = String(DrillUp.g_OH_self_list[i]["资源-自定义按钮"] || "Skill00");
...
// ** 存储数据变量初始化
//=============================================================================
var _drill_OH_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
	_drill_OH_initialize.call(this);
	...
	for( var i=0; i < DrillUp.g_OH_self_list.length; i++ ){
		...
		if( data == null ){
			this._drill_OH_self_status[i] = null;
		}else{
...
Drill_Operate_Hud.prototype.drill_updateStatus = function(){
	...
	for( var i=0; i < this._drill_OH_selfList.length; i++ ){
		...
		if( status == null || sprite == null ){ continue; }
