 ...
 * 结构：
 *   (1.配置分四个部分，角色面板、按钮组、角色面板、杂项数据。
 *      更多详细介绍，去看看"关于全自定义主菜单（配置表）.docx"。
 * 设计：
 *   (1.由于这里是主菜单，主菜单要求显示的数据最好健全。
 *      以下数据不建议隐藏：
 *        等级数值、角色名、
 *        生命数值、最大生命数值、
 *        魔法数值、最大魔法数值、
...
//
//		工作类型		持续执行
//		时间复杂度		o(n^3)*o(图像处理) 每帧
//		性能测试因素	主菜单界面
//		性能测试消耗	32.73ms（commandMoveTo）
//		最坏情况		
//		备注			
 //
 //插件记录：
 //		代码复杂度★★★★
 //		能加功能就加，尽量别删改功能，这里的位置参数要花非常长的时间才能弄明白。
 //
