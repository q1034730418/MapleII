...
Window_Lagomoro_Mission.prototype.initialize = function() {
    Window_Base.prototype.initialize.call(this, Graphics.boxWidth - this.windowWidth(), Graphics.boxHeight * (ConfigManager.Lagomoro_Mission_UD/100), this.windowWidth(), this.windowHeight());
...
Scene_Map.prototype.update = function() {
    this.Lagomoro_Mission_update();
    this._Lagomoro_MissionWindow.move(Graphics.boxWidth - this._Lagomoro_MissionWindow.windowWidth(), 0, this._Lagomoro_MissionWindow.width,this._Lagomoro_MissionWindow.height);
