...
/**
*matter.body模块包含用于创建和操作体模型的方法。
*“物质.身体”是一个刚体，可以用“物质.引擎”来模拟。
*在“matter.bodies”模块中可以找到常用身体配置（如矩形、圆形和其他多边形）的工厂。
*
*请参阅包含的用法[示例]（https://github.com/liabru/matter js/tree/master/examples）。
