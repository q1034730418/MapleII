...
Window_MusicComp.prototype.refresh = function() {
	...
	this.drawText(comp2, 0, 0, (this.width - 64),"right");
};
...
Scene_Music_Book.prototype.create_number_time = function() {
      ...
      this._sprite_number = new Sprite(new Bitmap(300,24))
...
Scene_Music_Book.prototype.refresh_number = function() {
	...
	this._sprite_number.bitmap.drawText(String(text),0,0,300,24,'center');
};
